...
- **메인 헤드라인** (홈 hero h1):
  ...
  - "욕이 나왔습니다"
  - "**그래서 만들었습니다**" (cyan 강조)
- **서브** (h1 아래 p 태그): "정밀하게 설계했습니다. / PETG 소재로 더 가볍게."
- **title / meta / OG**: title = "3D UniBox — 현장에서 욕이 나왔습니다", description = "정밀하게 설계한 PETG 브라켓. 현장에서 시작해 더 가볍게 만들었습니다."
- 2026-05-08 업데이트 (이전 카피 "없으면 만들고, 있으면 더 낫게" 폐기됨)
- **WHY 4개 카드** (왜 3D인가):
...
- **회사**: 에스디컨버전스 (대표 이두성)
- **전화**: 010-1234-5678 (예시값, 실제는 1588-0000 등 별도 안내처 있음)
