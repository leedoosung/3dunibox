  ...
  return (
    <div>
      ...
      <div style={{ padding: isMobile ? "20px 16px 40px" : "32px 80px 60px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.1fr 1fr", gap: isMobile ? 24 : 48 }}>
        <div>
          <div style={{ aspectRatio: "1", maxHeight: "70vh", background: m.image_url ? "#fff" : "linear-gradient(160deg, var(--navy-900), var(--navy-800))", borderRadius: 16, position: "relative", overflow: "hidden", display: "grid", placeItems: "center", border: "1px solid var(--line)" }}>
