...
const STEPS = [
  ...
  { n: "02", t: "케이블 정리", d: "벽 출선구에서 케이블을 끌어내 브라켓 ⌀8mm 채널에 통과시킵니다.", time: "2분", tip: "단말기 후면 커넥터 위치까지 50–80mm 여유를 두세요." },
  { n: "03", t: "브라켓 고정", d: "동봉된 M3 볼트 4개로 브라켓을 벽면에 체결하고 너트·와셔로 후면을 마감합니다.", time: "3분", tip: "벽 재질에 따라 적절한 앵커(콘크리트)·보강판(석고)을 사용하세요." },
  { n: "04", t: "단말기 결합", d: "단말기 후면을 브라켓 체결구에 맞춰 결합합니다.", time: "4분", tip: "토크 0.5N·m 이하로 균등하게 조여주세요." },
];
