              ...
              <div style={{ gridColumn: "span 2" }}>
                ...
                {editing.image_url && (
                  <div style={{ marginTop: 10, border: "1px solid var(--line)", borderRadius: 8, position: "relative", overflow: "hidden" }}>
                    ...
                    <div style={{ background: "rgba(255,255,255,0.02)", display: "flex", justifyContent: "center", alignItems: "center", aspectRatio: "3 / 4", maxHeight: 320, overflow: "hidden", padding: 12, boxSizing: "border-box" }}>
                      <img src={editing.image_url} alt="preview" style={{ maxWidth: "100%", maxHeight: "100%", width: "auto", height: "auto", display: "block" }} />
                    </div>
