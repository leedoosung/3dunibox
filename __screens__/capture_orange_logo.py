...
with sync_playwright() as p:
    ...
    p1 = OUT / "48-orange-logo-desktop.png"
    page.screenshot(path=str(p1), full_page=False, clip={"x": 0, "y": 0, "width": 800, "height": 200})
    print("ok:", p1.name, p1.stat().st_size)
    p1b = OUT / "48b-orange-logo-desktop-full.png"
    ...
    page = ctx.new_page()
    page.goto(URL); settle(page)
    p2 = OUT / "49-orange-logo-mobile.png"
